...
- [docs/ai/command-sandbox-implementation.md](docs/ai/command-sandbox-implementation.md): command-sandbox decisions, verified probes, security gates, and remaining work

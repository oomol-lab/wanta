...
| [docs/common-agent-dependencies.md](docs/common-agent-dependencies.md) | Before changing dependency auto-approval: curated Python/Node.js packages, bounded install rules, exclusions, and research basis        |

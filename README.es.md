...
La aplicación inicia el binario fijado `opencode-ai@1.18.30` como un sidecar `opencode serve` limitado
al loopback y lo controla con `@opencode-ai/sdk@1.18.30`. Los paquetes de OpenCode usan licencia MIT y

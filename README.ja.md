...
| ------------------------------------------------------------------ | -------------------------------------------------------- |
| 組み込み OpenCode ランタイムと Claude Code、Codex、Grok アダプター | レジストリ型アダプター層から ACP エージェントを追加      |
...
アプリは固定バージョンの `opencode-ai@1.18.30` バイナリをループバック専用の
`opencode serve` Sidecar として起動し、`@opencode-ai/sdk@1.18.30` から操作します。

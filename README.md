...
The application starts the pinned `opencode-ai@1.18.30` binary as a loopback-only `opencode serve`
sidecar and drives it through `@opencode-ai/sdk@1.18.30`. The OpenCode packages are MIT-licensed and

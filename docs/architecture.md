...
| teams         | `teams-client.ts` + `team-details-resource.ts` (members, authorizations, provider options as a short-lived shared resource, plus member/admin role changes); creators and admins may change any non-creator member between member and admin, except that an admin cannot change their own role; **the whole IPC service is deleted**                                                                                                                                                                                                                                                      | none                                                                                                                          |

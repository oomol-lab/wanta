...
| **OpenCode**      | The Agent kernel. Spawns the published binary `opencode-ai@1.18.21` as a sidecar; the main process drives it over HTTP+SSE via `@opencode-ai/sdk@1.18.21`. Pure configuration-level customization, zero source modification. At research time (2026-05) no community precedent was found for using OpenCode in non-IDE / general-agent workloads; Wanta was the first known case (positioned as a non-coding agent at inception; local coding capability was opened up later).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

...
| Custom tools were only `search_actions` / `call_action`                                                | Grew to four connector tools: added `inspect_action` (enforcing inspect-before-call) and `list_apps` (directly lists connected apps in the active workspace). WikiGraph access now uses Wanta's managed `wg` command on the sidecar `PATH`, not a custom OpenCode tool.                                                                                                                                                                                                                                                                                                                                               |

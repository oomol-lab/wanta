...
export class AgentManager {
  ...
  private readonly turnDirectories: ManagedTurnDirectories

  public constructor(options: AgentManagerOptions) {
    this.options = options
    this.turnDirectories = new ManagedTurnDirectories(options.rootDir)
  ...
  public async createArtifactDir(sessionId: string, projectRoot?: string): Promise<string> {
    return this.turnDirectories.createArtifactDir(sessionId, projectRoot)
  }

  public artifactSessionDir(sessionId: string, projectRoot?: string): string {
    return this.turnDirectories.artifactSessionDir(sessionId, projectRoot)
  }

  public async createProcessDir(sessionId: string): Promise<string> {
    return this.turnDirectories.createProcessDir(sessionId)
  }

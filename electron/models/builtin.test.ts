...
test("built-in model registry has unique ids and matching summaries", () => {
  ...
  assert.deepEqual(
    ...
    [
      { id: "oopilot", supportsImages: true, toolCall: true, runtimeKind: "openai-compatible", contextWindow: 200_000 },
      { id: "gpt-5.5", supportsImages: true, toolCall: true, runtimeKind: "openai-responses", contextWindow: 200_000 },
      {

...
// 渲染层各域用到的非简单请求头：连接器的 x-oo-team-name / 条件请求头、语音的 x-api-request-id、
// JSON POST 的 content-type 等。预检若带 Access-Control-Request-Headers 则优先回显之。
const defaultAllowHeaders =
  "authorization,content-type,accept,if-none-match,if-modified-since,x-oo-team-name,x-api-request-id"

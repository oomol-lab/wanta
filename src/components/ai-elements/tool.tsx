...
export type ToolHeaderProps = {
  ...
  /** 无可展开内容时禁用折叠并隐藏箭头，避免出现点击无反应的"死开关"。 */
  expandable?: boolean
  className?: string
}
...
export const ToolHeader = ({ className, title, type, state, expandable = true, ...props }: ToolHeaderProps) => (
  <CollapsibleTrigger
    disabled={!expandable}
    className={cn("flex w-full items-center justify-between gap-4 p-3", !expandable && "cursor-default", className)}
    {...props}
  >

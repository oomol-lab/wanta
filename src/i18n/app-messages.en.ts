...
export const enMessages = {
  ...
  "connections.discovery.aiTitle": "AI & models",
  "connections.discovery.aiDescription": "Use models, search, and media generation in agents and automation.",
  "connections.discovery.crossBorderTitle": "Cross-border ecommerce",
  "connections.discovery.crossBorderDescription": "Connect stores, orders, fulfillment, and market data.",
  "connections.discovery.communicationTitle": "Communication",
  "connections.discovery.communicationDescription": "Bring chat, email, notifications, and social workflows together.",
  "connections.discovery.knowledgeTitle": "Docs & knowledge",
  "connections.discovery.knowledgeDescription": "Work with documents, drives, and shared team knowledge.",
  "connections.discovery.productivityTitle": "Projects & productivity",
  "connections.discovery.productivityDescription": "Coordinate tasks, projects, and everyday work.",
  "connections.discovery.marketingTitle": "Marketing & growth",
  "connections.discovery.marketingDescription": "Connect campaigns, customer engagement, and growth data.",
  "connections.discovery.dataStorageTitle": "Data & storage",
  "connections.discovery.dataStorageDescription": "Query analytics, databases, search indexes, and file storage.",
  "connections.discovery.developerTitle": "Developer & cloud",
  "connections.discovery.developerDescription": "Connect source code, deployments, identity, and cloud services.",

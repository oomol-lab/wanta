...
export const enMessages = {
  ...
  "knowledge.libraryDescription":
    "Wanta analyzes your current team's sources and shows the evidence behind its answers.",
  "knowledge.askTitle": "Ask this knowledge base",
  "knowledge.askPlaceholder": "For example: What do these sources recommend for new products?",
  "knowledge.askScope": "Searches ready sources in the current team",
  "knowledge.askButton": "Start analysis",
  "knowledge.askFailed": "Could not start the analysis. Try again.",
  "knowledge.bookshelf": "My library",
  "knowledge.booksCount": "sources",
  "knowledge.backToLibrary": "Back to library",
  "knowledge.files": "Files",
  "knowledge.upload": "Upload file",
  "knowledge.dropToUpload": "Drop files to upload",
  ...
  "knowledge.emptyFiles": "No files yet",
  "knowledge.emptyResults": "No relevant content found",
  "knowledge.uploadHint": "Documents, spreadsheets, ebooks and images · Up to 150 MB per file",
  "knowledge.tooLarge": "The file exceeds 150 MB.",
  "knowledge.unsupportedType": "This file format is not supported.",
  "knowledge.delete": "Delete file",
  "knowledge.deleteConfirm": "Delete “{name}”? It will no longer appear in knowledge searches.",
  "knowledge.selectTeam": "Select an OOMOL team to use its knowledge base.",
  "knowledge.useInChat": "Use current team knowledge base",
  "knowledge.openFile": "View file",
  "knowledge.previewTab": "File preview",
  "knowledge.evidenceTab": "Search excerpts",
  "knowledge.noEvidence":
    "The current search did not find this file. Search excerpts do not represent the complete parsed file.",
  "knowledge.previewLoading": "Loading file…",
  "knowledge.previewUnavailable": "This file's content is currently unavailable.",
  "knowledge.previewTooLarge": "This file exceeds the preview limit. Use search to find relevant excerpts.",
  "knowledge.previewUnsupported":
    "Original file preview is not supported for this format. Search the knowledge base for relevant excerpts.",
  "knowledge.previewTruncated": "Showing the first 512 KB of this file.",
  "knowledge.previewServiceText":
    "This is text returned by the knowledge service and may differ from the original file layout.",
  "knowledge.previewPending": "This file is not ready to preview yet.",
  "knowledge.backToFiles": "Back to files",
  "knowledge.selectFileHint": "Select a file to preview it, or search the knowledge base for relevant excerpts.",
  "knowledge.showMoreEvidence": "Show excerpts",
  "knowledge.showLessEvidence": "Collapse excerpts",
  "knowledge.retryPreview": "Retry",
  "knowledge.openEvidence": "View source",
  "knowledge.status.queued": "Queued",
  "knowledge.status.upload_sending": "Uploading",
  "knowledge.status.parsing": "Parsing",
  "knowledge.status.parsed": "Parsed",
  "knowledge.status.index_sending": "Preparing index",
  "knowledge.status.indexing": "Indexing",
  "knowledge.status.mapping": "Mapping",
  "knowledge.status.ready": "Ready",
  "knowledge.status.failed": "Failed",
  "knowledge.status.uncertain": "Needs attention",
  ...
  "chat.inputPlaceholderLocal": "What can I help you do today? Use @ for files, / for commands, and $ for Skills",
  ...
  "billing.teamSchedule.title": "Scheduled subscription change",
  "billing.teamSchedule.target": "Target plan: {plan}; additional seats: {seats}",
  "billing.teamSchedule.cancel": "Cancel scheduled change",
  "billing.teamSchedule.cancelled": "Scheduled change cancelled.",
  "billing.teamSchedule.saved": "Subscription change scheduled.",
  ...
  "billing.teamPreview.description": "Review the target plan, additional seats and effective time before confirming.",
  ...
  "chat.draftProjectConflict":
    "The project already has a draft, or attachments are still importing. Open the project draft first, or wait for the import to finish.",
  "chat.draftOpenExisting": "Open target draft",
  "chat.draftImportInterrupted": "The previous attachment import was interrupted. Add the unfinished files again.",
  "chat.draftClear": "Clear draft",
  "chat.draftCleared": "Draft cleared",
  "chat.draftUndo": "Undo",
  "chat.draftImporting": "Adding attachments…",
  "chat.draftSaveFailed": "Draft has not been saved locally. Keep the app open.",
  "chat.attachmentPreview.read_failed": "The image could not be read",
  "chat.attachmentPreview.missing": "The image file is missing",
  "chat.attachmentPreview.too_large": "Images over 16 MB cannot be previewed",
  "chat.attachmentPreview.unsupported_type": "This image format cannot be previewed",
  "chat.attachmentPreview.unavailable": "Image unavailable. Retry or add it again",
  "chat.attachmentPreview.decode_failed": "The image could not be loaded",
  ...
  "artifacts.archiveShownCount": "{count} entries shown",

...
export const enMessages = {
  ...
  "chat.selfManagedSetupDescription": "Configure the missing parts whenever you're ready.",
  "chat.selfManagedModel": "Your model",
  "chat.selfManagedOpenConnector": "Your OpenConnector",
  "chat.configureOpenConnector": "Configure OpenConnector",
  "chat.setupComplete": "Configured",
  ...
  "billing.popover.tooltip": "Plans and seats",
  "billing.popover.title": "Plans and seats",
  "billing.popover.close": "Close plan and usage popover",
  ...
  "billing.usageSubscription.title": "Usage benefits",
  "billing.usageSubscription.meta": "Subscribe for top-up bonuses and monthly usage balance",
  "billing.usageSubscription.proTitle": "AI Pro",
  "billing.usageSubscription.proDescription": "For frequent model, built-in API, and connector usage.",
  "billing.usageSubscription.proPrice": "$20",
  "billing.usageSubscription.proFeatureDiscount": "Get 10% extra usage balance on every top-up",
  "billing.usageSubscription.proFeatureAllowance": "$22 in usage balance every month",
  "billing.usageSubscription.maxTitle": "AI Max",
  "billing.usageSubscription.maxDescription": "For heavy Agent and automation usage.",
  "billing.usageSubscription.maxPrice": "$100",
  "billing.usageSubscription.maxFeatureDiscount": "Get 20% extra usage balance on every top-up",
  "billing.usageSubscription.maxFeatureAllowance": "$120 in usage balance every month",
  "billing.usageSubscription.subscribe": "Subscribe to {plan}",
  "billing.usageSubscription.change": "Change subscription",
  "billing.usageSubscription.manage": "Manage subscription",
  ...
  "setup.title": "Choose how you want to use Wanta",
  "setup.description": "Use OOMOL for a ready-to-use experience, or bring your own model and optionally OpenConnector.",
  "setup.recommended": "Recommended",
  "setup.oomolTitle": "Use OOMOL",
  "setup.oomolDescription": "Sign in to use OOMOL cloud models, connectors, and team capabilities.",
  "setup.oomolAction": "Sign in or create account",
  "setup.selfManagedTitle": "Use my own runtime",
  "setup.selfManagedDescription": "Use your own model API without signing in to OOMOL. OpenConnector is optional.",
  "setup.selfManagedAction": "Start self-managed setup",
  "setup.back": "Back to setup options",
  ...
  "setup.skipDescription": "You can finish setup later inside Wanta.",
  ...
  "openConnector.runtimeUrlDescription": "Used for both the OpenConnector API and Console.",
  ...
  "settings.runtimeProfileOomolDescription": "Use OOMOL cloud models, connectors, and team capabilities.",
  ...
  "settings.modelsOomol": "OOMOL models",
  ...
  "settings.linkRuntimeDescription":
    "Choose which connector backend the agent uses. Model access and OOMOL sign-in are configured separately.",
  ...
  "knowledge.wordCount": "{count} words",

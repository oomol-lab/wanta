...
export const enMessages = {
  ...
  "knowledge.recoveryTitle": "Some knowledge files could not be opened",
  "knowledge.recoveryDescription":
    "These files are preserved in recovery storage. Other knowledge bases remain available. Repair the files or import newer copies.",
  "knowledge.recoveryReveal": "Show preserved file",

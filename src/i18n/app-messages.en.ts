...
export const enMessages = {
  ...
  "billing.subtitle":
    "Wanta plans center on seats, shared connections, and organization management. Usage balance covers model, built-in API, and connector spend.",
  ...
  "billing.popover.pendingPaymentRecommendation":
    "A Wanta plan or seat change is awaiting payment. Capacity updates after payment completes.",
  ...
  "billing.wantaPreview.title": "Confirm Wanta plan",
  "billing.wantaPreview.description": "Confirmation creates the checkout page and opens it in your system browser.",
  "billing.wantaPreview.plan": "Target plan",
  "billing.wantaPreview.seats": "Additional seats",
  "billing.wantaPreview.dueNow": "Due now",
  "billing.wantaPreview.total": "Cycle total",
  "billing.wantaPreview.timing": "Effective time",
  "billing.wantaPreview.immediate": "Effective immediately",
  "billing.wantaPreview.nextCycle": "Effective next cycle",
  "billing.wantaPreview.confirm": "Confirm and pay",
  "billing.managePermission.title": "This account cannot manage this organization's plan",
  "billing.managePermission.description":
    "Wanta plans and seats can only be managed by the organization owner or members with management permission. You can still view the current status and usage balance.",
  ...
  "billing.purchaseDialog.description":
    "Insufficient usage balance can interrupt model, built-in API, or connector calls. Manage Wanta plans and seats on the plan page.",

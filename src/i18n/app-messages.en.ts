...
export const enMessages = {
  ...
  "error.billingSessionExpired.description":
    "Your sign-in session expired. Sign in again to restore balance and usage information.",
  ...
  "billing.title": "Balance and usage",
  "billing.backToChat": "Back to chat",
  "billing.subtitle": "Review organization balance and model, built-in API, and connector usage.",
  ...
  "billing.popover.tooltip": "Balance and usage",
  "billing.popover.title": "Balance and usage",
  "billing.popover.close": "Close balance and usage popover",
  ...
  "billing.purchaseDialog.description":
    "Insufficient usage balance can interrupt model, built-in API, or connector calls.",

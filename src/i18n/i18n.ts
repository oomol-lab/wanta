...
const messages = {
  "zh-CN": {
    ...
    "sidebar.emptyDescription": "点上方“新对话”，把要完成的事告诉 Gimo。",
    "sidebar.search": "搜索任务",
    ...
    "session.renameFromTitlebar": "双击编辑对话标题",
    "chat.defaultTitle": "对话",
    "chat.newSession": "新会话",
    "chat.emptyTitle": "聊聊你的需求，我来帮你完成",
    "chat.inputPlaceholder": "给 Gimo 发送消息…",
    ...
    "chat.attachmentFolderPickerUnavailable": "当前环境无法选择文件夹，请使用桌面版 Gimo。",
    "chat.openAttachmentFailed": "无法打开附件：{error}",
    "chat.agentStarting": "Agent 启动中…",
    "chat.thinking": "Gimo 正在思考…",
    ...
    "chatError.authRequired.description": "登录后才能继续使用 Gimo。",
    ...
    "settings.theme": "主题",
    "settings.themeDescription": "选择 Gimo 的显示外观。",
    ...
    "settings.accountDiagnosticsTitle": "Gimo 账号诊断信息",
    "settings.copied": "已复制",
  ...
  en: {
    ...
    "sidebar.emptyDescription": "Start a new chat above and tell Gimo what to get done.",
    ...
    "chat.attachmentFolderPickerUnavailable": "This environment cannot choose folders. Use the Gimo desktop app.",
    "chat.openAttachmentFailed": "Could not open attachment: {error}",
    "chat.agentStarting": "Agent starting…",
    "chat.thinking": "Gimo is thinking…",
    ...
    "chatError.authRequired.description": "Sign in to continue using Gimo.",
    ...
    "settings.themeDescription": "Choose how Gimo should appear.",
    ...
    "settings.accountDiagnosticsTitle": "Gimo account diagnostics",

...
const messages = {
  "zh-CN": {
    ...
    "chat.queueHint": "当前回复完成后，会自动发送最后一条队列任务。",
    "chat.queueWillSend": "将发送",
    "chat.queueRemove": "移出队列",
    "chat.queueClear": "清空队列",
  ...
  en: {
    ...
    "chat.queueHint": "When the current response finishes, Lumo will send the latest queued message.",
    "chat.queueWillSend": "Will send",
    "chat.queueRemove": "Remove from queue",
    "chat.queueClear": "Clear queue",

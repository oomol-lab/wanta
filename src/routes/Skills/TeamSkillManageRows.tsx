...
export function TeamInstallMissingButton({
  busy,
  className,
  count,
  disabled,
...
export function TeamSkillManageLoadingSkeleton({ inline }: { inline: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div className={listClassName}>
        <TeamSkillManageRowSkeleton titleWidth="w-32" descriptionWidth="w-3/4 max-w-md" metaWidth="w-56" />
        <TeamSkillManageRowSkeleton titleWidth="w-40" descriptionWidth="w-5/6 max-w-lg" metaWidth="w-64" />
        <TeamSkillManageRowSkeleton titleWidth="w-28" descriptionWidth="w-2/3 max-w-sm" metaWidth="w-48" />
      </div>
    </div>
  )
}

function TeamSkillManageRowSkeleton({
  descriptionWidth,
  metaWidth,
  titleWidth,
}: {
...
function TeamSkillIconFrame({ icon }: { icon?: string }) {
...
export function TeamSkillPackageListSkeleton() {
  return (
    ...
    >
      <ConfirmDialogContent>
        <ConfirmDialogHeader>
          <ConfirmDialogTitle>
            {target
              ? t("teams.skillManageRemoveRuntimeConfirmTitle", { name: target.displayName })
              : t("teams.skillManageRemoveRuntime")}
          </ConfirmDialogTitle>
          <ConfirmDialogDescription>{t("teams.skillManageRemoveRuntimeConfirmDescription")}</ConfirmDialogDescription>
        </ConfirmDialogHeader>
        <ConfirmDialogFooter>
...
export function TeamPackageRemoveConfirmDialog({
  busy,
  onClose,
  onConfirm,
  packageSkillCount,
  ...
  target: UseTeamSkills["skills"][number] | null
}) {
  const { t } = useAppI18n()
    ...
    >
      <ConfirmDialogContent>
        <ConfirmDialogHeader>
          <ConfirmDialogTitle>
            {target
              ? t("teams.skillManageRemovePackageConfirmTitle", { name: target.packageName })
              : t("teams.skillManageRemovePackage")}
          </ConfirmDialogTitle>
          <ConfirmDialogDescription>
            {t("teams.skillManageRemovePackageConfirmDescription", { count: packageSkillCount })}
          </ConfirmDialogDescription>
        </ConfirmDialogHeader>
        <ConfirmDialogFooter>
          <ConfirmDialogCancel disabled={busy}>{t("common.cancel")}</ConfirmDialogCancel>

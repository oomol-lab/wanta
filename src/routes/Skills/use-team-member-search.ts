...
import { errorMessage, minimumMemberSearchLength, userFallback } from "./team-management-model.ts"
import { searchUsers } from "@/lib/teams-client"

interface UseTeamMemberSearchOptions {
...
export function useTeamMemberSearch({ addMemberOpen, members }: UseTeamMemberSearchOptions) {
